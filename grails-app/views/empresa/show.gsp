		...
		<div id="show-empresa" class="content scaffold-show" role="main">
			...
			<ol class="property-list empresa">
				<f:with bean="${empresaInstance }">
						<f:field property="nombre" input-disabled="true"/>
						<f:field property="rfc" input-disabled="true"/>
						
						<f:display property="direccion" value="${empresaInstance.direccion }"/>
						<f:display property="certificadoDigital"/>
					</f:with>
			</ol>
